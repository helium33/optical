...
const FeatureDetail = () => {
  ...
  } = useSWR(`http://localhost:3001/features/${id}`, fetcher);
  ...
  const handleAddToBag = (product) => {
    if (product.stock > 0) {
      navigate(`/cart/${product.id} `, { state: { product } }); // Pass product data to cart
    } else {
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/2">
            ...
            <p className="text-yellow-500 mb-4 flex items-center gap-1">
              ...
              <span className="text-gray-600 text-sm ml-2">({product.star})</span>
            </p>
            <div className="mb-6">
